...
┏━━━━❮📝 ᴅᴇᴛᴇʟᴇꜱ 📝❯━━━
┃🗣️ 𝚄𝚜𝚎𝚛 : ${pushname}
┃🤖 𝙱𝚘𝚝 : 𝐒𝙷𝙰𝙶𝙴𝙴 𝐌𝙳 V${packageJson.version}
...
┗━━━━━━━━━━━━━━━
  ...
  TIKTOK: function (title, author, q) {
    return `
🎟️ *𝐒𝙷𝙰𝙶𝙴𝙴 𝐌𝙳 TIKTOK DOWNLOADER* 🎟️
...
🎬 *Enjoy the video brought to you by 𝐒𝙷𝙰𝙶𝙴𝙴 𝐌𝙳 Bot!* 
        `.trim();
  },
  VIDEO: function (data) {
    return `
